...
fun MarquageQuestionsScreen(
    ...
    Surface(modifier = Modifier.fillMaxWidth()
        ...
        Scaffold(
            topBar = {
                SurveyTopAppBar(
                    questionIndex = marquageScreenData.questionIndex,
                    totalQuestionsCount = marquageScreenData.questionCount,
            ...
            bottomBar = {
                SurveyBottomBar(
                    shouldShowPreviousButton = marquageScreenData.shouldShowPreviousButton,
                    shouldShowDoneButton = marquageScreenData.shouldShowDoneButton,
...
fun SurveyBottomBar(
    ...
    //is nextbutton enabled
    Log.i("isNextButtonEnabled", isNextButtonEnabled.toString())
    Surface(
