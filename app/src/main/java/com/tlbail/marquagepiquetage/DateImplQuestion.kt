...
fun DateImplQuestion(
    ...
    val marquage = marquageState.collectAsState()
    QuestionWrapper(
        ...
        val dateString = dateFormat.format(marquage.value.date.timeInMillis ?: getDefaultDateInMillis())
    ...
    MarquagePiquetageTheme {
        Surface {
            DateImplQuestion(
                ...
                marquageState = MutableStateFlow(Marquage()),
                onClick = {},
            )
        }
    }
